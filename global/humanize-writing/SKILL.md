...
version: 2.0.0
description: |
  Remove signs of AI-generated writing from general text. Use when the user says
  a draft sounds AI-generated, robotic, promotional, or unnatural. This is a
  general editing lens; when a project-specific editorial skill applies, that
  project workflow and terminology take priority.
allowed-tools:
  - Read
  - Write
  - Edit
...
## Boundary With Domain Editorial Skills

Use `humanize-writing` for general prose cleanup: remove AI tells, inflated
claims, robotic rhythm, and promotional filler.

When a project-specific editorial skill applies, use that skill as the authority
for facts, voice, required structure, and safety language. This skill can support
the naturalness pass but must not override project editorial or operational
rules.
